...
Not independently re-checked since — figures below are carried forward, not
re-verified in this 2026-07-28 pass.
...
PRs #102 and #103, re-confirmed live once more by PR #105 (2026-07-27), carried
forward without re-check by #108 (2026-07-28) and by this run. None of the prior
status PRs (#65–#108) have merged (see `STATUS.md`), so PR descriptions are not a
durable record; this file and `STATUS.md` are the intended durable one, once merged.
