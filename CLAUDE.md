...
**CONFLICT-002 (filed 2026-07-26, unresolved by owner):** the canonical Drive Brain also runs a
much larger, active "Tiny West: Iron Trail v6 no-size-cap rebuild" program entirely outside this
repo (current gate 4.46 MB; the 1.2 MB ceiling below is explicitly revoked upstream, effective
2026-07-19). This repo's constants remain binding **here** pending an owner ruling on whether this
repo is still canonical. See `docs/tiny-west-brain/CONFLICT-002.md`.
